...
create_clock -add -name gtpclk0_pin -period 20.00 -waveform {0 3.200} [get_ports {GTP_CLK_P}];
set_property -dict { PACKAGE_PIN E10 } [get_ports { FMC_MGT_CLK_N }];
set_property -dict { PACKAGE_PIN F10 } [get_ports { FMC_MGT_CLK_P }];
create_clock -add -name mgtclk1_pin -period 20.00 -waveform {0 3.200} [get_ports {FMC_MGT_CLK_P}];
...
set_property -dict { PACKAGE_PIN K13  IOSTANDARD LVCMOS12 } [get_ports { sw_6 }]; #IO_L19P_T3_A22_15 Sch=sw[6]
set_property -dict { PACKAGE_PIN M17  IOSTANDARD LVCMOS12 } [get_ports { sw_7 }]; #IO_25_15 Sch=sw[7]
...
set_property -dict { PACKAGE_PIN J20   IOSTANDARD LVCMOS12 } [get_ports { jtagB_tms }]; #IO_L11P_T1_SRCC_15 Sch=fmc_la01_cc_p
...
set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS12 } [get_ports { serial_tl_1_in_bits_phit[0] }]; #IO_L20N_T3_A19_15 Sch=fmc_la_n[07]
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS12 } [get_ports { jtagB_tck] }]; #IO_L20P_T3_A20_15 Sch=fmc_la_p[07]
set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS12 } [get_ports { serial_tl_1_in_bits_phit[2] }]; #IO_L24N_T3_RS0_15 Sch=fmc_la_n[08]
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS12 } [get_ports { fjtagB_tdi }]; #IO_L24P_T3_RS1_15 Sch=fmc_la_p[08]
...
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS12 } [get_ports { serial_tl_1_out_bits_phit[2] }]; #IO_L22N_T3_A16_15 Sch=fmc_la_n[11]
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS12 } [get_ports { jtagB_tdo }]; #IO_L22P_T3_A17_15 Sch=fmc_la_p[11]
...
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS12 } [get_ports { serial_tl_1_in_bits_phit[3] }]; #IO_L23N_T3_FWE_B_15 Sch=fmc_la_n[15]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS12 } [get_ports { serial_tl_1_in_ready }]; #IO_L23P_T3_FOE_B_15 Sch=fmc_la_p[15]
set_property -dict { PACKAGE_PIN G18   IOSTANDARD LVCMOS12 } [get_ports { serial_tl_1_in_bits_phit[1] }]; #IO_L4N_T0_15 Sch=fmc_la_n[16]
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS12 } [get_ports {  serial_tl_1_out_valid  }]; #IO_L4P_T0_15 Sch=fmc_la_p[16]
...
set_property -dict { PACKAGE_PIN B17   IOSTANDARD LVCMOS12 } [get_ports {  serial_tl_1_clock_in}]; #IO_L11P_T1_SRCC_16 Sch=fmc_la17_cc_p
...
set_property -dict { PACKAGE_PIN A19   IOSTANDARD LVCMOS12 } [get_ports { serial_tl_1_out_bits_phit[1] }]; #IO_L17N_T2_16 Sch=fmc_la_n[19]
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS12 } [get_ports { serial_tl_1_out_bits_phit[0] }]; #IO_L17P_T2_16 Sch=fmc_la_p[19]
set_property -dict { PACKAGE_PIN F20   IOSTANDARD LVCMOS12 } [get_ports { serial_tl_1_out_bits_phit[3] }]; #IO_L18N_T2_16 Sch=fmc_la_n[20]
...
set_property -dict { PACKAGE_PIN E19   IOSTANDARD LVCMOS12 } [get_ports { reset_A }]; #IO_L14P_T2_SRCC_16 Sch=fmc_la_p[21]
set_property -dict { PACKAGE_PIN D21   IOSTANDARD LVCMOS12 } [get_ports { jtagA_tck }]; #IO_L23N_T3_16 Sch=fmc_la_n[22]
set_property -dict { PACKAGE_PIN E21   IOSTANDARD LVCMOS12 } [get_ports { reset_B }]; #IO_L23P_T3_16 Sch=fmc_la_p[22]
...
set_property -dict { PACKAGE_PIN C13   IOSTANDARD LVCMOS12 } [get_ports { jtagA_tdo }]; #IO_L8P_T1_16 Sch=fmc_la_p[28]
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS12 } [get_ports { jtagA_tms }]; #IO_L3N_T0_DQS_16 Sch=fmc_la_n[29]
...
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS12 } [get_ports { uart_txd }]; #IO_L9N_T1_DQS_16 Sch=fmc_la_n[32]
set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS12 } [get_ports { uart_rxd}]; #IO_L9P_T1_DQS_16 Sch=fmc_la_p[32]
set_property -dict { PACKAGE_PIN F14   IOSTANDARD LVCMOS12 } [get_ports { jtagA_tdi }]; #IO_L1N_T0_16 Sch=fmc_la_n[33]
