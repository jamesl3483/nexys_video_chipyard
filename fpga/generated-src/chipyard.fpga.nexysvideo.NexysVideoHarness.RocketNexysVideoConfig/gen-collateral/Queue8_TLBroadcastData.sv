...
module Queue8_TLBroadcastData(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  ram_8x72 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_data, io_enq_bits_mask})	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_mask = _ram_ext_R0_data[7:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
